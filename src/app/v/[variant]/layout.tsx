...
// import WAFChunkInterceptor from '@/components/WAFChunkInterceptor'; // DISABLED
...
const RootLayout = async ({ children, params, modal }: RootLayoutProps) => {
  ...
  return (
    <html dir={direction} lang={locale} suppressHydrationWarning>
      <head>
        {/* WAF interceptors script DISABLED */}
        {/* <script
          dangerouslySetInnerHTML={{ __html: `// WAF interceptors disabled` }}
        /> */}
        {/* WAF interceptors DISABLED */}
        {/* <WAFChunkInterceptor /> */} {/* DISABLED */}
      </head>
      <body>
        <NuqsAdapter>
          <GlobalProvider
