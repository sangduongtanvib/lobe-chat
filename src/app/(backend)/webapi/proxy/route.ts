...
export const POST = async (req: Request) => {
  ...
  try {
    ...
    console.error('Proxy error:', err); // DNS lookup 127.0.0.1(family:4, host:127.0.0.1.nip.io) is not allowed. Because, It is private IP address.
