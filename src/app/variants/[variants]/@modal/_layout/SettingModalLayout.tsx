...
import Header from '@/app/variants/[variants]/(main)/settings/_layout/Desktop/Header';
import SideBar from '@/app/variants/[variants]/(main)/settings/_layout/Desktop/SideBar';
