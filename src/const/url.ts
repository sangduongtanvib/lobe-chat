...
export const OFFICIAL_URL = 'https://vib.com.vn';
export const OFFICIAL_PREVIEW_URL = 'hhttps://vib.com.vn';
export const OFFICIAL_SITE = 'https://vib.com.vn';

export const OG_URL = '/og/cover.png?v=1';

// URL đến GitHub repository của dự án (lấy từ trường homepage trong package.json)
export const GITHUB = pkg.homepage;
// URL đến trang tạo issue mới trên GitHub repository
export const GITHUB_ISSUES = urlJoin(GITHUB, 'issues/new/choose');
export const CHANGELOG = 'https://vib.com.vn';
export const DOCKER_IMAGE = 'https://vib.com.vn';
...
export const AGENTS_INDEX_GITHUB = 'https://vib.com.vn';
...
export const EMAIL_SUPPORT = 'sang.duongtan@vib.com.vn';
export const EMAIL_BUSINESS = 'sang.duongtan@vib.com.vn';

export const MEDIDUM = 'https://vib.com.vn';
export const X = 'https://vib.com.vn';
