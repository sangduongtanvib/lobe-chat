...
const CDN_FONT_URLS = {
  'https://registry.npmmirror.com/@lobehub/webfont-mono/latest/files/css/index.css': '/fonts/webfont-mono.css',
  'https://registry.npmmirror.com/@lobehub/webfont-harmony-sans/latest/files/css/index.css': '/fonts/harmony-sans/index.css',
  'https://registry.npmmirror.com/@lobehub/webfont-harmony-sans-sc/latest/files/css/index.css': '/fonts/harmony-sans-sc/index.css',
  'https://registry.npmmirror.com/katex/latest/files/dist/katex.min.css': '/fonts/katex/katex.min.css',
} as const;
...
export function setupFontProxy() {
  ...
  window.fetch = async (input: string | URL | Request, init?: RequestInit): Promise<Response> => {
    ...
    if (url.includes('registry.npmmirror.com') && (url.includes('.woff') || url.includes('.woff2'))) {
      try {
...
export function setupXHRProxy() {
  ...
  XMLHttpRequest.prototype.open = function(
    ...
    // Handle font files
    if (finalUrl.includes('registry.npmmirror.com') && (finalUrl.includes('.woff') || finalUrl.includes('.woff2'))) {
      try {
